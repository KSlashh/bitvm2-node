...
mod tests {
    ...
    fn test_pegin_opreturn_script() {
        ...
        let instance_id = instance_id.as_bytes().to_vec();
        ...
        let msg = [magic.clone(), instance_id.clone(), evm_address.clone()].concat();
        ...
        let msg_misspelled_magic = [misspelled_magic, instance_id.clone(), evm_address].concat();
        ...
        let msg_invalid_evm_address = [magic, instance_id, suspicious_evm_address].concat();
