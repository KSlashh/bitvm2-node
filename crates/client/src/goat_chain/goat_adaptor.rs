...
impl ChainAdaptor for GoatAdaptor {
    ...
    async fn btc_spv_post_block_hash(
        ...
        bail!("BitcoinSPV.postBlockHash is not available in the gc contract interface")
    }
    ...
    async fn btc_spv_post_block_hash_batch(
        ...
        bail!("BitcoinSPV.postBlockHashBatch is not available in the gc contract interface")
    }
