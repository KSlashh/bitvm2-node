        ...
        loop {
            tokio::select! {
                _ = tokio::time::sleep(Duration::from_secs(interval)) => {
                    ...
                    update_long_running_task(&local_db, args.start, args.batch_size, args.output_proof.clone(), public_value_hex, proof_size as i64, cycles, StateChainProofBuilder::name(), proving_duration as i64, proving_time as i64, zkm_version).await?;
