...
$CMD push-seq --goat-block-number $GOAT_BLOCK_NUMBER --next-publishers=$PUBLISHERS --init-genesis --commit-info="../circuits/data/commit-chain/commit_info.json.0"
...
$CMD push-seq --goat-block-number $GOAT_BLOCK_NUMBER --commit-info="../circuits/data/commit-chain/commit_info.json.1"
...
# broadcast publisher changes to Bitcoin
$CMD --publishers=$NEXT_PUBLISHERS push-seq --goat-block-number $GOAT_BLOCK_NUMBER --next-publishers=$PUBLISHERS --commit-info="../circuits/data/commit-chain/commit_info.json.2"
