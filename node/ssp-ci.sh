...
$CMD push-seq --goat-block-number $HEIGHT --next-publishers=$PUBLISHERS

echo -e "set the new publisher set: publishers => next_publishers"
HEIGHT=$(($HEIGHT+1))
$CMD payfee

$CMD sign-seq --owner-btc-key-wif cMec2DGaTXkYJYfi7x3ZGjRXkeqmAvYAoWzMAcWj5fdLaqudWsNi --goat-block-number $HEIGHT
$CMD sign-seq --owner-btc-key-wif cMgZD2qsGReP1UvGbNQ7moL6PZFgzsuPFV3St8sGwpNxED4hqkEM --goat-block-number $HEIGHT
$CMD sign-seq --owner-btc-key-wif cMiWPrRA5KYDiRAq4nkgGsEf2TfcpqGbhT6YbfDpoy8ZsaAHiDeo --goat-block-number $HEIGHT
...
$CMD --publishers=$NEXT_PUBLISHERS sign-seq --owner-btc-key-wif cMec2DGaTXkYJYfi7x3ZGjRXkeqmAvYAoWzMAcWj5fdLaqudWsNi --goat-block-number $HEIGHT --next-publishers=$PUBLISHERS --clean-sigs

# submit update-seq-set to GOAT
$CMD --publishers=$NEXT_PUBLISHERS --goat-evm-prvkey 0xbb094981331d23f14f6fec3749c2bc6effa582d52a0c92c6b257809d89d37ab6 update-seq-set --goat-block-number $HEIGHT --next-publishers=$PUBLISHERS 
$CMD --publishers=$NEXT_PUBLISHERS --goat-evm-prvkey 0x134e45328c0cf16fa450e9b40c34cba16a7eac2001b907f1de6a28549776f93e update-seq-set --goat-block-number $HEIGHT --next-publishers=$PUBLISHERS 
...
# update publisher on GOAT
$CMD --publishers=$NEXT_PUBLISHERS push-pub --goat-block-number $HEIGHT --next-publishers=$PUBLISHERS --next-publisher-btc-pubkeys=$PUBLISHERS_BTC_PUBKEYS

# broadcast publisher changes to Bitcoin
$CMD --publishers=$NEXT_PUBLISHERS push-seq --goat-block-number $HEIGHT --next-publishers=$PUBLISHERS